...
public class DefaultHDShader implements HDShader {
    ...
    private class OurBiomeShaderState extends OurShaderState {
        private OurBiomeShaderState(OurMapIterator mapiter, HDMap map, MapChunkCache cache) {
    ...
    private class OurBiomeRainfallShaderState extends OurShaderState {
        private OurBiomeRainfallShaderState(OurMapIterator mapiter, HDMap map, MapChunkCache cache) {
            super(mapiter, map, cache);
        }
        @Override
        protected Color[] getBlockColors(DynmapBlockState blk) {
    ...
    private class OurBiomeTempShaderState extends OurShaderState {
        private OurBiomeTempShaderState(OurMapIterator mapiter, HDMap map, MapChunkCache cache) {
            super(mapiter, map, cache);
        }
        @Override
        protected Color[] getBlockColors(DynmapBlockState blk) {
    ...
    @Override
    public String[] getCurrentBlockMaterials(DynmapBlockState blk, OurMapIterator mapiter, int[] txtidx,
            BlockStep[] steps) {
        return nulllist;
    }
}
