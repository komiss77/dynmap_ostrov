...
import org.dynmap.bukkit.helper.BukkitHelper;
...
public class DynmapPlugin extends JavaPlugin implements DynmapAPI {
    ...
    public class BukkitServer extends DynmapServerInterface {
        ...
        public double getCacheHitRate() {
        	return helper.gencache.getHitRate();//helper.useGenericCache() ? helper.gencache.getHitRate() : SnapshotCache.sscache.getHitRate();
        }
        @Override
        public void resetCacheStats() {
        	//if (helper.useGenericCache()) {
        		helper.gencache.resetStats();
        	//}
        	//else {
  ...
  /*  public void loadExtraBiomes(String mcver) {
    ...
    private void doEnable() {
       ...
       // if (helper.useGenericCache()) {
        	helper.gencache = new GenericChunkCache(core.getSnapShotCacheSize(), core.useSoftRefInSnapShotCache());        	
      //  }
      //  else {
    ...
    public void onDisable() {
      ...
      //  	SnapshotCache.sscache = null; 
       // }
        if (helper.gencache != null) {
        	helper.gencache.cleanup();
        	helper.gencache = null; 
        }
        Log.info("Disabled");
    }
    ...
    private void invalidateSnapshot(String wn, int x, int y, int z) {
    	//if (helper.useGenericCache()) {
    		helper.gencache.invalidateSnapshot(wn, x, y, z);      	
    	//}
    	//else {
    ...
    //	if (helper.useGenericCache()) {
    		helper.gencache.invalidateSnapshot(wname, minx, miny, minz, maxx, maxy, maxz);
    	//}
    	//else {
