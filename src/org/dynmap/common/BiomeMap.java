...
public class BiomeMap {
    ...
    private static Map<String, BiomeMap> biome_by_rl = new HashMap<>();
    private static CaseInsensitiveMap<BiomeMap> biome_by_name = new CaseInsensitiveMap<>();
    ...
    private BiomeMap(int idx, String id, double tmp, double rain, int waterColorMultiplier, int grassmult, int foliagemult, String rl) {
        ...
        //    if (b.getKey().value().equalsIgnoreCase(id)) {
        //    }
        //}
    ...
    public static final BiomeMap byBiomeName(String name) {
        BiomeMap b = biome_by_name.get(name);
        return (b != null) ? b : NULL;
    }
